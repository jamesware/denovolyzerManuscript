This repo contains source code to produce a methods paper describing the application of **denovolyzeR** to the analysis of *de novo* variants identified in human exome sequencing.
